...
After images are sent to CustomVision.ai these predictions can be monitored. Each result can be turned into a new test sample in order to train the model even better.
